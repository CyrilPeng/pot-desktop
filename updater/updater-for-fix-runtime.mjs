...
async function resolveUpdater() {
    ...
    const windows_x86_64 = `https://dl.pot-app.com/https://github.com/CyrilPeng/pot-desktop/releases/download/${version}/pot_${version}_x64_fix_webview2_runtime-setup.nsis.zip`;
    ...
    const windows_i686 = `https://dl.pot-app.com/https://github.com/CyrilPeng/pot-desktop/releases/download/${version}/pot_${version}_x86_fix_webview2_runtime-setup.nsis.zip`;
    ...
    const windows_aarch64 = `https://dl.pot-app.com/https://github.com/CyrilPeng/pot-desktop/releases/download/${version}/pot_${version}_arm64_fix_webview2_runtime-setup.nsis.zip`;
